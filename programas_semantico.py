...
print("------------------------------------------------------------------------")
subprocess.call(['./Implementacion/sintactico', './Ejemplos/Semanticos/declaracion_variables_lss.pimf'])
print("========================================================================")
...
print("------------------------------------------------------------------------")
subprocess.call(['./Implementacion/sintactico', './Ejemplos/Semanticos/subprograma_declara_parametro.pimf'])
print("========================================================================")
espera = input("Presiona intro cuando quieras seguir...")
print("\n\n\n")
...
print("------------------------------------------------------------------------")
subprocess.call(['./Implementacion/sintactico', './Ejemplos/Semanticos/subprograma_numero_tipo_fuera_alcance.pimf'])
print("========================================================================")
espera = input("Presiona intro cuando quieras seguir...")
print("\n\n\n")
...
print("------------------------------------------------------------------------")
subprocess.call(['./Implementacion/sintactico', './Ejemplos/Semanticos/error_tipo_expresiones_logicas_aritmeticas.pimf'])
print("========================================================================")
espera = input("Presiona intro cuando quieras seguir...")
print("\n\n\n")
...
print("------------------------------------------------------------------------")
subprocess.call(['./Implementacion/sintactico', './Ejemplos/Semanticos/errores_expresiones_listas.pimf'])
print("========================================================================")
espera = input("Presiona intro cuando quieras seguir...")
print("\n\n\n")
